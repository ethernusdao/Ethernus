...
// File contracts/Etus.sol

// Original license: SPDX_License_Identifier: MIT
// Compatible with OpenZeppelin Contracts ^5.0.0
pragma solidity ^0.8.22;
/// @custom:security-contact ethernustoken@gmail.com
contract Ethernus is ERC20, ERC20Burnable, ERC20Pausable, Ownable, ERC20Permit {
    constructor(address initialOwner)
        ERC20("Ethernus", "ETUS")
        Ownable(initialOwner)
        ERC20Permit("Ethernus")
    {
